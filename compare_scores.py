...
files_before = [
    ...
    'Resnet_base/runs/20_poison/gan2:pre&gan3:pre&sdXL:pre&real:pre/scores/gan2:pre&gan3:pre&sdXL:pre&real:pre_vs_gan3:pre.pkl',
    ...
    'Resnet_base/runs/20_poison/gan2:pre&gan3:pre&sdXL:pre&real:pre/scores/gan2:pre&gan3:pre&sdXL:pre&real:pre_vs_sdXL:pre.pkl',
]

files_after = [
    'Resnet_base/runs/50_poison/gan2:pre&gan3:pre&sdXL:pre&real:pre/scores/gan2:pre&gan3:pre&sdXL:pre&real:pre_vs_gan2:pre.pkl',
    'Resnet_base/runs/50_poison/gan2:pre&gan3:pre&sdXL:pre&real:pre/scores/gan2:pre&gan3:pre&sdXL:pre&real:pre_vs_gan3:pre.pkl',
    'Resnet_base/runs/50_poison/gan2:pre&gan3:pre&sdXL:pre&real:pre/scores/gan2:pre&gan3:pre&sdXL:pre&real:pre_vs_real:pre.pkl',
    'Resnet_base/runs/50_poison/gan2:pre&gan3:pre&sdXL:pre&real:pre/scores/gan2:pre&gan3:pre&sdXL:pre&real:pre_vs_sdXL:pre.pkl',
]
